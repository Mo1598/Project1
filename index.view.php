...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            ...
            <a class="navbar-brand" href="#" style="font-weight:bold;">UpWork</a>
          ...
          <a class="nav-link" href="#">Home <span class="sr-only">(current)</span></a>
                    ...
                    <li class="nav-item">
                        <i class="fas fa-question" style="padding-top:0.6rem; margin-left:2rem; font-size:24px;"></i>
                    </li>
                    <li class="nav-item">
                        <i class="far fa-bell" style="padding-top:0.6rem; margin-left:2rem; font-size:24px;"></i>
                    </li>
                    <li class="nav-item">
                        <i class="fab fa-telegram-plane"
                            style="padding-top:0.6rem; margin-left:2rem; font-size:24px;"></i>
                    </li>
                    <li class="nav-item">
